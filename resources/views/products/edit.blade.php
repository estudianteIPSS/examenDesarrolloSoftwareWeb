            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="descripcion_larga" name="descripcion_larga" rows="5" required
                        class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500">{{ old('descripcion_larga', $product->descripcion_larga) }}</textarea>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            id="precio_neto"
                            name="precio_neto"
                            value="{{ old('precio_neto', $product->precio_neto) }}"
                            min="0"
                            step="0.01"
                            required
                    ...
                    <div>
                        ...
                        <input
                            type="number"
                            id="precio_venta"
                            value="{{ number_format($product->precio_venta, 2, '.', '') }}"
                            step="0.01"
                            readonly
                ...
                <div>
                    ...
                    <input type="number" min="0" id="stock_bajo" name="stock_bajo"
                        value="{{ old('stock_bajo', $product->stock_bajo) }}" required
                        class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                </div>
                ...
                <div>
                    ...
                    <input type="number" min="0" id="stock_alto" name="stock_alto"
                        value="{{ old('stock_alto', $product->stock_alto) }}" required
                        class="w-full rounded-lg border-gray-300 focus:border-blue-500 focus:ring-blue-500">
                </div>
